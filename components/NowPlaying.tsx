      ...
      {status === 'success' && data && (
        <>
          ...
          {((data as CurrentEpisode).isPlaying === false ||
            ...
            <p className="font-medium text-primary">Not Playing</p>
          )}

          <a
            className="font-medium text-primary truncate lg:text-lg"
            href={data.url!}
            target="_blank"
            rel="noopener noreferrer"
          >
            {!!(data as CurrentEpisode)['podcast'] ? (
              <p className="inline-flex items-center space-x-2 truncate">
