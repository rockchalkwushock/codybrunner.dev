...
I was able to submit 3 PR's on the day and I'm happy with what I was able to do for the organization. Since my boot camp is taking the week off I plan on setting aside time over the next week to kill issues on the website adding features and functionality.
...
You can checkout and help out on the project by going to the organizations [Github](https://github.com/HighFivesFoundation).
