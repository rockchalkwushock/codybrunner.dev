...
- [x] ~~Add feature for displaying top X tracks and artists from Spotify.~~
- [x] ~~Add feature for displaying my activity stats from Strava.~~
- [x] ~~Add feature for displaying my activity from Github.~~
- [x] ~~Add feature for displaying my reading activity.~~

### Blog

- [ ] Search feature for posts
- [x] Related Posts
- [x] Migrate old blog post and add under `archived` flag.
